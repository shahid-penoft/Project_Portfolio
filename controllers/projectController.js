    ...
    try {
        ...
        const items = rows.map(r => {
            ...
            return {
                ...
                daysLeft,
                expiresOn: expiresOnTime.toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata', day: '2-digit', month: 'short', year: 'numeric' }),
                deletedBy: r.deleted_by_name || 'Admin User',
                deletedOn: r.deleted_at ? `${new Date(r.deleted_at).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata', day: '2-digit', month: 'short', year: 'numeric' })} · ${new Date(r.deleted_at).toLocaleTimeString('en-IN', { timeZone: 'Asia/Kolkata', hour: '2-digit', minute: '2-digit', hour12: true })}` : '—',
